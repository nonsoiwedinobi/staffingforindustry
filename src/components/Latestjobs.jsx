...
import { fetchJobs } from "../services/contentful";
import "../index.css";
    ...
    <section className="py-12 bg-gray-100">
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 px-[8%]">
          {jobs.map((job) => (
            <a href="#" key={job.sys.id} className="group">
              <div className="border-2 bg-gray-200 rounded-3xl shadow-2xl shadow-black/40 relative overflow-hidden p-6 flex flex-col h-full">
                <div className="flex justify-between">
                  <span className="pr-2 block">
                    <span className="h-7 px-3 text-sm rounded-full whitespace-nowrap flex items-center font-medium bg-white/10">
                      {job.fields.category}
                    </span>
                  </span>
                ...
                <div className="mt-6 pb-4 mb-4 border-b-2 border-white/20 flex-1 flex flex-col">
                  ...
                  <div className="flex overflow-x-hidden scrollbar-hide mt-4">
                    <span className="pr-2 block">
                      <span className="h-7 px-3 text-sm rounded-full whitespace-nowrap flex items-center gap-2 font-medium bg-white/10">
