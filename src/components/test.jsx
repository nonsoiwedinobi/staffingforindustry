<a href="#" className="group">
  <div className=" border-2 bg-gray-200 rounded-3xl shadow-2xl shadow-black/40 relative overflow-hidden  p-6 flex flex-col h-full hover:border-gray-400 transition duration-300">
    ...
    <div className="mt-6 pb-4 mb-4 border-b-2 border-gray-400 flex-1 flex flex-col">
      <h2 className="text-xl font-semibold">E&amp;I Engineer Hoogspanning</h2>
      <p className="mt-1 text-md flex-1 line-clamp-3">
        Jouw verantwoordelijkheden zijn: Als customer support officer ben je
        samen met je collega’s hét commerciële aanspreekpunt voor onze klanten,
        bij al hun vragen en/of opmerkingen. Je staat dagelijks onze klanten te
        woord via telefoon of e-mail en beantwoordt vakkundig al hun
        productvragen.
      </p>
